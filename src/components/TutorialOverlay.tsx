...
const SECTIONS: Section[] = [
  {
    title: '① 神とデッキを選ぼう',
    body: '好きな神と難易度を選び、デッキを組みます。最初は「おすすめデッキ」のままで大丈夫です。神によっては「神技」（得意技）があり、神選択画面に表示されます。',
...
const TIPS: string[] = [
  ...
  // D2b：BASE-D（決定109）で未使用APペナルティは廃止済みのため、旧文言
  // 「余らせすぎるとスコアが少し減る」は虚偽になっていた。実仕様に合う内容へ差し替え
  '神力（AP）は次のラウンドへ持ち越せません。使い切る前提でカードを選びましょう。',
